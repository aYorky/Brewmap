...
public class RegisterActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        //Email
        final EditText emailEditText = (EditText) findViewById(R.id.EamilEditText);
            ...
            public void onClick(View view) {
                ...
                if (first_name.equals("") || last_name.equals("") || username.equals("") || email.equals("") || password.equals("")) {
                    ...
                    if(!email.equals(emailVer) && !password.equals(passwordVer)){
                        Toast.makeText(RegisterActivity.this, "E-mails and passwords do not match.", Toast.LENGTH_SHORT).show();
                    } else {
                        if (!password.equals(passwordVer)){
                            ...
                            if (!email.equals(emailVer)){
                                Toast.makeText(RegisterActivity.this, "E-Mails do not match.", Toast.LENGTH_SHORT).show();
